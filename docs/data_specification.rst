...
.. list-table:: Case Data Columns
   ...
   * - ``samples_tested``
     - Integer
     - Number of samples tested for dengue on that date in the district (OPTIONAL - Not used in pipeline currently)
   * - ``case``
     - Integer
...
- **Primary Metrics**:
  ...
  - Number of samples tested per day (Optional - Not used in pipeline currently)
